...
Thank you, Michael. Regarding CapEx, I've mentioned before that we have a hybrid model for our data centers. We use both our own data centers and third-party providers, which means our CapEx figures might not be directly comparable to others. However, we are currently rolling out the Apple Intelligence features and ensuring we have sufficient capacity for them. You can find the CapEx amounts we've incurred in fiscal '24 in our 10-K, and in fiscal '25, we will continue making all necessary investments, including those related to AI.
...
Thank you very much. I want to reiterate what was said about Luca. I wish you well. My first question pertains to the iPhone, specifically regarding the fourth calendar quarter, which is your first quarter. When you anticipate mid- to low-single-digit revenue growth, do you foresee the iPhone experiencing faster growth? Additionally, what are your thoughts on this in relation to China, which continues to show improvement each quarter? Thank you again. I also have a follow-up.
...
Thanks, Luca. Tim, I'd like to ask about the current concerns surrounding builds and lead times, especially since you are projecting mid- to low-single-digit growth. This doesnâ€™t seem to indicate any major issues based on what you might be hearing. I recognize you are focused on running the business, but with your extensive experience, what do you think people are overlooking? It appears your outlook is quite measured, and the revenue guidance suggests stability. Additionally, you have a strong product cycle. What excites you, and what do you believe people are missing? Thank you, Tim.

**Tim Cook** _CEO_

Ben, I couldn't be more excited about Apple Intelligence and the upcoming rollout. I'm actively working on future releases, and it's transforming my daily life. I'm really enthusiastic about the health features we're introducing. The number of emails I'm receiving from customers who have taken a hearing test and are using their AirPods Pro 2 as hearing aids is incredible and heartwarming. I'm also very pleased about the sleep apnea notifications that we'll offer through the watch. This week is particularly exciting for us as we've launched three different Macs, including desktops and laptops. We have a lot planned, and it's certainly the strongest lineup we've ever had heading into the holiday season. As for the noise, I just tune it out because otherwise, it would be overwhelming. That's what I do; I can't comment for others, but that's my approach.
...
Good afternoon. Thanks for taking my questions. I have two as well. And Luca, best of luck in the future. It's been a pleasure working with you. I guess the first one I have is, away from iPhones, on the Services side, you're adding $100 billion run rate with Services today, which is a phenomenal achievement by itself. As you look at the Services portfolio today, can you just talk about how much of this business do you think is recurring versus transactional? And are the growth rates different between the subscription portfolio over here versus transactional portfolio?

**Luca Maestri** _CFO_

Yes, Amit, I'll take this one. We are very happy with this important milestone of reaching a $100 billion run rate. Looking back a few years, the growth has been phenomenal, and we are pleased with our diversified portfolio of services. The recurring revenue has grown and is increasing at a faster rate than the transactional revenue. Currently, we have over 1 billion paid subscriptions on our platform, including our own services and third-party services, and that number continues to grow in strong double digits. Overall, we feel very confident, and yes, the recurring portion is indeed growing faster than the transactional one.
...
Sure, I'll address the question about China. Looking at our performance for the quarter, we remained relatively stable compared to last year. A significant factor contributing to this improvement was a sequential rise in foreign exchange rates, which has been a challenge for us for some time. Additionally, our active device installed base reached a record high. We also had the top two selling smartphones in Urban China, according to Kantar. More than 50% of new customers are purchasing products like Mac and iPad, and over 75% of watch buyers are new to the product. These are some positive indicators. Regarding the stimulus, our team is focused on it, but Iâ€™m not an economist, so I prefer not to speculate on its impact.
...
As I said, David, we're not providing that level of color. We're giving you some data on services. I would repeat what I said earlier. We're very early in the cycle, very early in the cycle with a lot of new products and features that we are launching. And we're very excited about them, but it's early. And the Apple Intelligence rollout is going to happen over time, not across the world as normally we do with software releases.
...
Yes, David. It's obviously a different pace than what we typically do. As we mentioned at WWDC, our goal was to provide a comprehensive vision of Apple Intelligence, and we indicated that it would be rolled out gradually. We are on track with what we stated at WWDC, and our execution is going well. Regarding the demand curve, we believe there is a strong motivation for upgrading. This is reflected in my personal experience and the feedback I'm receiving. We'll see how it unfolds. However, we are not providing projections beyond the current quarter. That's not something we do.
...
If you look at our schedule, we began with US English on Monday. There's another release coming that will introduce additional features I mentioned in December, which will be available not only in US English but also localized for the UK, Australia, Canada, Ireland, and New Zealand. We plan to add more languages in April, although we haven't finalized the specifics yet. We'll continue to expand language options throughout the year. We're progressing as quickly as we can while ensuring quality. That's our approach.
...
Got it. Thanks for that, Luca. I have a quick follow-up. I know Apple Intelligence is currently a feature on the phone, but do you think it could potentially contribute to the growth of the services business in the future, or are those areas too different to assess? Thank you.

**Tim Cook** _CEO_

I think it's important to note that Apple Intelligence is available on the Mac for the M-series products and on certain models of iPad, in addition to the iPhone. So, it's present on all three devices. What was your follow-up question? Keep in mind that we were have released a lot of APIs and developers will be taking advantage of those APIs. That release has occurred as well and of course more are coming. And so I, definitely believe that a lot of developers will be taking advantage of Apple Intelligence in a big way. And what that does to Services, I'll not forecast, but I would say that from an ecosystem point of view, I think it will be great for the user and the user experience.
...
Thank you very much. My first question is for Tim. I would like to ask about some components in Services. Despite your installed base, certain parts of the Apple One bundle, such as Music, News, Arcade, and Fitness, do not seem to be leading the market. What changes might occur to improve that, and which other services are experiencing faster growth or have expanding addressable markets, similar to what we've observed in pay or advertising?

**Tim Cook** _CEO_

I see a lot of opportunities in this area. There are many customers we can engage to capitalize on these offerings, and we will keep investing in Services while adding new features. Whether it's News+, Music, or Arcade, that's our plan. It's important to note that our focus is on being the best rather than the biggest. In some instances, many of the services you've mentioned are not cross-platform. We develop them specifically for our customers, which may affect who ends up selling the most, but our goal remains to deliver the best quality.

**Luca Maestri** _CFO_

Our operating expenses have increased over the years, and at the same time, we've experienced a significant improvement in gross margin, which I might not have anticipated a few years ago. We've managed to excel in several areas. Each time we plan for the upcoming year, we consider various ways to allocate our resources to support business growth. Looking at our long-term performance, we've done quite well. Our core philosophy is to prioritize the business, and if we have surplus cash, we will keep returning it to our shareholders, a strategy that has been quite effective so far.
